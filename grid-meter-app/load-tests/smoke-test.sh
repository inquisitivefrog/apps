#!/usr/bin/env bash
# Runs all four profiles with small/fast overrides (few threads, short duration, small meter
...
PROFILES=(steady-state ramp-up spike soak)
FAILURES=0
